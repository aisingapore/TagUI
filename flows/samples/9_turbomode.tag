...
if !p1
    ...
    run curl -k -s -L -o tagui.sikuli/tagui.py https://github.com/kelaberetiv/TagUI/files/6997365/tagui_sikuli_core.txt
    ...
    run curl -k -s -L -o tagui.sikuli/tagui.py https://raw.githubusercontent.com/kelaberetiv/TagUI/master/src/tagui.sikuli/tagui.py
