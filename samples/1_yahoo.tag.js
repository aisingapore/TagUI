...
var flow_path = 'C:/Users/ZBOOK15G5_46/home/projects/TagUI/src/samples';
...
chrome_step('Page.navigate',{url: 'https://ca.yahoo.com'}); sleep(1000);
techo('https://ca.yahoo.com' + ' - ' + chrome.getTitle() + '\n');});
...
function then() {chrome.sendKeys(tx('search-box'),'github');},
function timeout() {this.echo('ERROR - cannot find search-box').exit();});}});

casper.then(function() {{techo('show search-box');
casper.waitFor(function check() {return check_tx('search-box');},
function then() {this.echo(chrome.fetchText(tx('search-box')).trim());},
function timeout() {this.echo('ERROR - cannot find search-box').exit();});}});
...
function then() {chrome.click(tx('search-button'));},
...
casper.then(function() {casper.wait(6600, function() {});});
...
chrome.capture('C:/Users/ZBOOK15G5_46/home/projects/TagUI/src/samples/results.png');}});

casper.then(function() {{techo('snap logo to logo.png');
casper.waitFor(function check() {return check_tx('logo');},
function then() {chrome.captureSelector('C:/Users/ZBOOK15G5_46/home/projects/TagUI/src/samples/logo.png',tx('logo'));},
function timeout() {this.echo('ERROR - cannot find logo').exit();});}});
...
if (download_path.indexOf(':')>0) download_path = download_path.replace(/\//g,'\\').replace(/\\/g,'\\');
chrome_step('Page.setDownloadBehavior',{behavior: 'allow', downloadPath: download_path});
chrome_step('Page.navigate',{url: 'https://duckduckgo.com'}); sleep(1000);
techo('https://duckduckgo.com' + ' - ' + chrome.getTitle());});
...
function then() {chrome.sendKeys(tx('search_form_input_homepage'),'The search engine that doesn\'t track you.');},
...
chrome.capture('C:/Users/ZBOOK15G5_46/home/projects/TagUI/src/samples/duckduckgo.png');}});

casper.then(function() {techo('wait 4.4 seconds');});
casper.then(function() {casper.wait(4400, function() {});});
