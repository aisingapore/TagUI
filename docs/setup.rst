...
To install TagUI Microsoft Word Plug-in (a full-featured RPA studio to make RPA very accessible), download the `MS Word Plug-in installer <https://github.com/kelaberetiv/TagUI/releases/download/v6.64.0/TagUIWordAddInSetupV3.09.zip>`_, unzip the file and double-click Setup.exe. Download the `MS Excel Plug-in installer <https://github.com/kelaberetiv/TagUI/releases/download/v6.64.0/TagUIExcelAddInSetupV3.05.zip>`_ to configure RPA data and parameters in Excel and run TagUI from Excel.
