...
To install TagUI Microsoft Word Plug-in (a full-featured RPA studio to make RPA very accessible), download the `Plug-in installer <https://github.com/kelaberetiv/TagUI/releases/download/v6.46.0/Word_Add-in_v3.zip>`_, unzip the file and double-click Setup.exe.
