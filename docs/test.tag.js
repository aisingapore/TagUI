...
var flow_path = 'C:/Users/ZBOOK15G5_46/home/projects/TagUI/docs';
...
chrome_step('Page.navigate',{url: 'https://google.com'}); sleep(1000);
techo('https://google.com' + ' - ' + chrome.getTitle() + '\n');});
...
casper.then(function() {{techo('keyboard [ctrl]v[enter]'); var fs = require('fs');
if (!sikuli_step('keyboard [ctrl]v[enter]')) if (!fs.exists('[ctrl]v[enter]'))
this.echo('ERROR - cannot find image file [ctrl]v[enter]').exit(); else
this.echo('ERROR - cannot find [ctrl]v[enter] on screen').exit(); this.wait(0);}});
