...
### PILOT AND UPDATES
Tebel.Automation, the solo-engineer startup that created TA.Gui, is now calling out globally to businesses and individuals to implement pilot web automation projects FREE OF CHARGE. [See this announcement](https://medium.com/tebelorg/tebel-automation-is-calling-out-for-free-implementation-of-web-automation-2c0c4130d753) if you have a repetitive or time-sensitive task / process that you think might be good to automate.

Get updates on TA.Gui automation news by emailing hi@tebel.org. Unsubscribe anytime by emailing bye@tebel.org. Newsletter service managed by a homemade mailbot, extended from the open-source mailbot TA.Mail. More automation stuff @ tebelorg on Facebook, Twitter, YouTube, Medium.
