...
2. Download and unzip [Word Add-in zip file](https://storage.googleapis.com/tagui-dependencies/TagUI%20WordAddIn/TagUIWordAddInSetupV3.17.zip) (double-click Setup.exe to start installing)
