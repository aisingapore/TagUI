...
function techo(echo_string) {if (!quiet_mode) {if (flow_language == 'english') casper.echo(echo_string); else 
{var translated_string = translate(echo_string,'to',flow_language); casper.echo(translated_string);
...
if (!script_line) return 'ERROR - translation engine script_line parameter missing';
...
language_count = language_data.length-2;}
